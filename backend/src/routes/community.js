...
try {
    const posts = [
    { id: 'post1', author: 'Dr. Rajesh Kumar', content: 'New insights on heart health management', imageUrl: 'http://localhost:3000/images/heart-health.jpg', likes: 15, comments: ['Great post!', 'Very informative'], timestamp: new Date().toISOString() },
    { id: 'post2', author: 'Dr. Emily Davis', content: 'Pediatric care tips for flu season', imageUrl: 'http://localhost:3000/images/pediatric-care.jpg', likes: 12, comments: ['Helpful!', 'Thanks for sharing'], timestamp: new Date().toISOString() },
    { id: 'post3', author: 'Dr. Alice Turner', content: 'Latest advancements in neurology', imageUrl: 'http://localhost:3000/images/neurology.jpg', likes: 20, comments: ['Excellent research!', 'Very detailed'], timestamp: new Date().toISOString() },
    { id: 'post4', author: 'Dr. Priya Sharma', content: 'Nutritional advice for chronic diseases', imageUrl: 'http://localhost:3000/images/nutrition-tips.jpg', likes: 18, comments: ['Useful tips!', 'Great content'], timestamp: new Date().toISOString() },
    ];
